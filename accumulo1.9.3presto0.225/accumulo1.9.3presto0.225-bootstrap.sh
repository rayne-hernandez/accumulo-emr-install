...
aws s3 cp s3://kountable2.0/dev/emr/accumulo-presto/bootstrap/presto0.225-install.sh /home/hadoop/
# Copy backup script from S3
aws s3 cp s3://kountable2.0/dev/accumulo/emr/accumulo-presto/accumulo-backup.sh /home/hadoop/
